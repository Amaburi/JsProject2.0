         ...
         <div class="flex">
            ...
            <div class="box">
               ...
               <select name="min" class="input" required>
                  ...
                  <option value="4000000">4000k</option>
                  <option value="5000000">5000k</option>
                  <option value="6000000">6000k</option>
                  <option value="7000000">7000k</option>
                  <option value="8000000">8000k</option>
                  <option value="9000000">9000k</option>
                  <option value="10000000">10000k</option>
                  <option value="11000000">11000k</option>
                  <option value="12000000">12000k</option>
                  <option value="13000000">13000k</option>
                  <option value="14000000">14000k</option>
               </select>
            </div>
            <div class="box">
               <p>maximum budget</p>
               <select name="max" class="input" required>
                  ...
                  <option value="13000000">13000k</option>
                  <option value="14000000">14000k</option>
                  <option value="15000000">15000k</option>
                  <option value="16000000">16000k</option>
               </select>
            </div>
            <div class="box">
               <p>status</p>
